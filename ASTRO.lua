if game.GameId == 113491250 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Pupsscar/script/refs/heads/main/SORRY.lua", true))()
else
	local HyperEscape = { 
		GUI = {
			GUIButton = true;
	...
	local Window = DeleteMobLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "ASTRO");
	...
	SettingsInfoSector:CreateCoppyText("Made By SCarrych");
	SettingsInfoSector:CreateCoppyText("tapai hamstera 🐹");
	...
	local Fov = Instance.new("ScreenGui",(CoreGui or localPlayer.PlayerGui))Fov.Name = "Fov" Fov.ZIndexBehavior = Enum.ZIndexBehavior.Sibling Fov.ResetOnSpawn = false; 
	...
	local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border"; game:GetService("StarterGui"):SetCore("SendNotification", {Title = "IA PIDOR", Text = "VI TOZE"});
